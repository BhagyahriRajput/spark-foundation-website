...
?>
    <div class="container">
        <h2 style="color:black; text-transform:uppercase; letter-spacing:2px; margin-top:5rem; font-size: 3rem;">Transaction</h2>
            <?php
                include 'connection.php';
                $sid=$_GET['id'];
        ...
        <div>
            <table class="table table-striped table-condensed table-bordered" style="border:1px solid rgb(186 128 128); font-size: 1.6rem;">
